...
+ Summary of star pixel positions in the original images
  ...
  | F656N-1997 | 385.47 | 385.46 |  -0.0010 |
  | F502N-1997 | 385.24 | 385.26 |  -0.0014 |
  | F487N-1997 | 385.18 | 385.22 |  -0.0011 |
  | F547M-1997 |  385.0 |  385.1 |   0.0010 |
  | F375N-1997 | 385.05 | 384.69 |  -0.0011 |
  | F437N-1997 |  385.0 |  384.7 | -0.00006 |
  | F658N-1998 | 924.75 | 895.58 |   -0.009 |
  | F502N-1998 | 924.51 | 895.61 |   -0.003 |
  | F555W-1998 |  924.9 |  895.75 |   -0.002 |
...
#+begin_src python :var TAB=hst-star-xy-pixels-and-bg ONLY="F555W-1998"
  from pathlib import Path
  import numpy as np
  from astropy.io import fits
