...
+ Assume 10 mas/yr = 95 km/s
 ...
 |---------------+-----+-----+--------+--------+--------+--------+--------|
 | NE Blue       | -45 |  43 | -0.956 |   -44. |    62. |      5 |    7.2 |
 | SE Blue       | -30 |  47 | -1.567 |   -57. |    56. |      5 |    6.0 |
 | SW Faint Blue | -26 |   ? | #ERROR | #ERROR | #ERROR |      6 | #ERROR |
 | N Red         | +25 |   9 |  0.360 |    20. |    27. |      4 |   11.7 |
 | SW Red        | +39 |  22 |  0.564 |    29. |    45. |      7 |   14.4 |
 | N Jet         | +23 |  62 |  2.696 |    70. |    66. |     15 |   16.0 |
 #+TBLFM: $4=$3/$2;f3::$5=arctan($4);f0::$6=hypot($2, $3);f0::$8=$-1/sin(abs($5));f1
