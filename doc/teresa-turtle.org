...
|------------------+-------+--------+--------+-----+-----+----+-------+---+-------+---+--------+---+--------+--------+------+---------+------+---------+-------|
|                  |     1 |      0 |      1 |   1 |     |    |     1 |   |   0e0 |   |    0e0 |   | 31941. | 0.9982 | 5.00 | 1.00016 |      | 1 / 0e0 | 6.1e0 |
#+TBLFM: $4=$2 - $3::$8=$4 $5**2;f0::$10=$4 $pi $6 $7;f0::$12=$4 $pi 0.5 $6**2;f0::$14=$8 $9 + $10 $11 + $12 $13::$15=$14/32000;f4::$16=sqrt($4/$5) / 0.2;f2::$17=$14/$16 58682;f5::$19=1/ $16 $18**2 ;f0::$20=30.5/$16;s2::@20$14=vsum(@I..@II)::@20$17=vsum(@I..@II)
...
| Component          | Ha frac | Density     | Mass frac |   |
|--------------------+---------+-------------+-----------+---|
| Inner shells       | 44 %    | 3000 \to 4500 | 26 %      |   |
| Intermediate shell | 13 %    | 500 \to 750   | 45 %      |   |
| Knot complexes     | 42 %    | 2000 \to 5000 | 21 %      |   |
| Outer Lobes        | 1 %     | 160 \to 320   | 8 %       |   |
|--------------------+---------+-------------+-----------+---|
| Bright peak        | 3%      | 10000       |           |   |
| NW knot            | 0.01%   | 8000        |           |   |
