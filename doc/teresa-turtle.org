...
+ Actual shell part is 50% fainter
+ Taking Max Red and N Blue as V extremes
  + V = -46.5 +/- 18.5 km/s
+ On the blue side, there is a blueward gradient of 8 km/s from S to N
+ Total y extension is [-5.3, 4.6] = -0.35 +/- 4.95
...
***** Slit F
+ x = -3.6
+ In this one, I didn't separate the shell from the N Red Complex
  + So V of Center Red might be too red
...
+ Assume 10 mas/yr = 95 km/s
 ...
 | SW Faint Blue | -26 | ?         | #ERROR           | #ERROR      | #ERROR       |      6 | #ERROR          |
