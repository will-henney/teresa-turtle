...
*** TODO [2/8] Beto comments
1. [X] Figure A1, A3, A4 - make numbers bigger
2. [ ] Figure 8 indicate star
3. [X] Add star to all the figure
4. [ ] Eskimo comparison
   + Add two discussion
5. [ ] Mention occulting bar
6. [ ] Mention peanut shape
7. [ ] Move appendix A to main
8. [ ] Telescope operators

*** Michael new comments
...
***** TODO f) Normalmente, agradezco de nombre a los operadores de telescopio.  Indiqué los operadores de telescopio en la Tabla 1 para las temporadas donde tengo esa información.  No tengo la información para las temporadas en junio 1998 y julio 2013.  ¿Beto?
Pendiente
...
***** TODO Page 19 - telescope operators
...
*** TODO [2/4] Figure changes from Michael comments
