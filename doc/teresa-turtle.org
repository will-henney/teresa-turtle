...
+ F(H\beta) = 1.1e-10 erg/cm2/s,  E(H\beta) = 4.239e-12 erg
+ => Q(H\beta) = F(H\beta) 4\pi D^2 / E(H\beta) = 1.242e+46 s^-1
+ From Osterbrock,
...
+ Hence, recombination rate is 13.8 1.242e+46 = 1.714e+47 s^-1, which is 35% of ionizing photon luminosity
  + *Conclusion:* nebula is matter-bounded, but only just
    + Optical depth to ionizing photons is -ln(1 - Recs/Q) = 0.4
