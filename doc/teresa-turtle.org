...
|-------------+------+-------+-------+--------+---------------+--------------+---------------+--------------+------|
|             |      |       |       |        | -39.1 +/- 0.5 | 29.5 +/- 2.0 |               | 19.2 +/- 1.2 |      |
#+TBLFM: @17$6=vmeane(@I..@II);f1::@17$7=vmeane(@I..@II);f1::@17$9=vmeane(@I..@II);f1
...
|-----------+------+-------+------+--------+---------------+----+------+--------------+------|
|           |      |       |      |        | -39.5 +/- 0.6 | 20 |      | 60.4 +/- 4.7 |      |
#+TBLFM: @6$6=vmeane(@I..@II);f1::@6$7=vmeane(@I..@II);f1::@6$9=vmeane(@I..@II);f1
...
+ Central region - bright complexes of knots (mainly 2015 spectra)
  ...
  + SE Blue Complex (includes K-SE)
    | slit |         |     x |    y |   y1 |   y2 |   V |      S |
    |------+---------+-------+------+------+------+-----+--------|
    | c'   | spm0031 | +4.19 |   -3 | -5.1 | -1.9 | -78 |  0.004 |
    |      | spm116  | +4.63 | -4.2 |   -6 |   -3 | -75 | 0.0095 |
...
***** TODO Make better figures of these images
+ Based on [[id:9B0BB7D0-1CFB-4129-A918-B4A7CB085941][Make figures of maps]] from Raman project

#+begin_src python :tangle ../scripts/turtle-rgb-map-nii-knots.py
  import numpy as np
...
#+RESULTS:
[[file:../turtle-rgb-map-nii-knots.png]]
